      ...
      <ol className="mt-4 flex gap-2 font-sans text-xs font-bold tracking-[0.14em] uppercase" aria-label="Checkout steps">
        {STEPS.map((step, index) => (
          <li
            ...
            className={`rounded-full px-3 py-1 ${index <= 1 ? "bg-palm text-white" : "bg-cream text-smoke"}`}
          >
            {index + 1}. {step}
          </li>
        ))}
      ...
      <div className="mt-6 grid gap-4 lg:grid-cols-2">
        <Card>
          ...
          <CardContent>
            ...
            <p className="mt-4 border-t border-line pt-3 font-display text-2xl tracking-wide text-palm tabular-nums">
  ...
  return (
    <main>
      <Container className="pt-8 pb-4 sm:pt-10">
        <p className="font-sans text-xs font-bold tracking-[0.2em] text-gold uppercase">Almost yours</p>
